...
import { AboutStatBox as StatBox, AboutSeverityBadge as SeverityBadge, AboutFlagCard as FlagCard } from "../components";
...
export default function AboutFlagStep({ data }) {
  if (!data) return null;
        ...
        {flags
          ...
          .map((flag, i) => (
            <div key={i} className="min-h-[120px]">
              <FlagCard flag={flag} backContent={flag.about} />
            </div>
          ))}
      </div>
